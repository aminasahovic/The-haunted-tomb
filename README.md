...
The Game in Unity (KGR) is a project developed collaboratively with [@marichusein](https://github.com/marichusein) as part of the Computer Graphics course. It is a game built using the Unity game engine and programmed in C#. The game takes players on an exciting adventure into an ancient tomb in search of a long-lost treasure. The tomb is  designed as a complex labyrinth, adding an element of challenge and disorientation to the gameplay.
